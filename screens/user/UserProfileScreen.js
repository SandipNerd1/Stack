    ...
    return (
      ...
      >
        {section.title === "Developer name" ? (
          ...
          <MaterialIcons name="description" size={24} color="#001b3a" style={{ marginLeft: -3 }} />
        )}
        <Text
          style={{
    ...
    <ScrollView showsVerticalScrollIndicator={false}>
      <View style={styles.screen}>
        ...
        <View style={{ paddingVertical: SCREEN_HEIGHT / 20 }}>
          ...
          <AnimatedButton
            navigateTo={() => Linking.openURL('https://pocketstack.herokuapp.com')}
          >
            <AntDesign name="infocirlceo" size={20} color="#001b3a" />
            <Text style={styles.navigateText}>About the app</Text>
          </AnimatedButton>
          <AnimatedButton
            navigateTo={() => Linking.openURL('https://pocketstack.herokuapp.com/privacy-policy')}
          >
